...
import { BETA_COOKIE, isRedeemableCode } from "@/lib/beta";

/**
 * Beta entry link: `/beta?code=XYZ` — the shared env code or a per-person
 * invite from /admin/users. If the code is valid, drop a short-lived
...
export async function GET(req: Request) {
  ...
  if (await isRedeemableCode(code)) {
